...
export PATH=$HOME/bin:/usr/local/share/python:/usr/local/lib/wxPython/bin:/usr/local/bin:/usr/local/sbin:/sbin:/usr/local/Cellar/ruby/1.9.2-p180/bin:/usr/local/share/npm/bin:$PATH
